    ...
    <DashboardLayout>
      <div className="md:flex md:items-center md:justify-between mb-6">
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Grade assignments with AI assistance and provide personalized feedback
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] bg-gray-50 dark:bg-gray-800 rounded-lg border border-dashed border-gray-300 dark:border-gray-700">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
          The AI-assisted grading feature is currently under development. Check back soon for updates!
        </p>
      </div>
    </DashboardLayout>
  );
